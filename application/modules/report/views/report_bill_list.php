							...
							<?php foreach ($student as $row) : ?>
								<tr>
									...
									<?php foreach ($bulan as $key) : ?>
										...
										<td style="color:<?php echo ($key['bulan_bill']==$key['bulan_total_pay']) ? '#00E640' : 'red' ?>"><?php echo ($key['bulan_bill']==$key['bulan_total_pay']) ? 'Lunas' : number_format($key['bulan_bill'], 0, ',', '.') ?></td>
										<?php } ?>
									<?php endforeach ?>
