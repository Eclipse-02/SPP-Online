			...
			<div class="col-xs-12"> 
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="form-group">						
							...
							<?php if(majors() == 'senior') { ?>
								<label for="" class="col-sm-2 control-label">Rayon</label>
								<div class="col-sm-2">
					...
					<div class="col-sm-10">
						...
						<?php if(majors() == 'senior') { ?>
							<a class="btn btn-warning btn-sm" href="<?php echo site_url('manage/payment/add_payment_bebas_majors/' . $payment['payment_id']) ?>"><span class="glyphicon glyphicon-plus"></span> Berdasarkan Rayon</a>
						<?php } ?>
