					...
					<div class="box-header">
						...
						<div class="box-tools">
							...
							<div class="input-group input-group-sm" style="width: 250px;">
								<input type="text" id="field" autofocus name="n" <?php echo (isset($f['n'])) ? 'placeholder="'.$f['n'].'"' : 'placeholder="Nama Rayon"' ?> class="form-control" required>
						...
						<div id="p_scents_majors">
								<div class="row">
									<div class="col-md-6">
										...
										<input type="text" required="" name="majors_name[]" class="form-control" placeholder="Contoh: Tarogong Kaler 1">
									</div>
									<div class="col-md-6">
										<label>Singkatan</label>
										<input type="text" required="" name="majors_short_name[]" class="form-control" placeholder="Contoh: Tarkal 1">
									</div>
								</div>
							</div>
