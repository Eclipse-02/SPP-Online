...
class Log_trx_model extends CI_Model {
    ...
    function get($params = array()) {
        ...
        if (isset($params['bulan_id'])) {
            $this->db->where('bulan_pay_bulan_pay_id', $params['bulan_id']);
        }
        ...
        $this->db->select('bulan_pay_bulan_pay_id, log_trx.student_student_id, student_nis, bulan_pay_bill, month_name, bebas_pay_bill');
        ...
        $this->db->join('bulan_pay', 'bulan_pay.bulan_pay_id = log_trx.bulan_pay_bulan_pay_id', 'left');
    ...
    function add($data = array()) {
        ...
        if (isset($data['bulan_pay_bulan_pay_id'])) {
            $this->db->set('bulan_pay_bulan_pay_id', $data['bulan_pay_bulan_pay_id']);
        }
    ...
    function delete_log($params = array()) {
        ...
        if (isset($params['bulan_pay_id'])) {
            $this->db->where('bulan_pay_bulan_pay_id', $params['bulan_pay_id']);
        }
