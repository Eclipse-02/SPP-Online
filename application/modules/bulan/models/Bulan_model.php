...
class Bulan_model extends CI_Model {
    ...
    function get($params = array())
    {
        ...
        $this->db->select('bulan.bulan_id, bulan_bill, bulan_total_pay, bulan_input_date, bulan_last_update');
    ...
    if(isset($data['bulan_total_pay'])) {
        $this->db->set('bulan_total_pay', $data['bulan_total_pay']);
    }

    if (isset($data['increase_budget'])) {
        $this->db->set('bulan_total_pay', 'bulan_total_pay +' . $data['increase_budget'], FALSE);
    }

    if (isset($data['decrease_budget'])) {
        $this->db->set('bulan_total_pay', 'bulan_total_pay -' . $data['decrease_budget'], FALSE);
    }
