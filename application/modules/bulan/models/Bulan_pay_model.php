...
class Bulan_pay_model extends CI_Model {
    ...
    function get($params = array())
    {
        ...
        $this->db->select('bulan_pay.bulan_pay_id, bulan_pay_bill, bulan_pay_bill, bulan_pay_number, bulan_pay_desc, bulan_pay_input_date, bulan_pay_last_update');
        $this->db->select('bulan_pay.bulan_bulan_id, bulan_bill');
        // $this->db->select_sum('bulan_pay_bill');
        ...
        $this->db->join('users', 'users.user_id = bulan_pay.user_user_id', 'left');
